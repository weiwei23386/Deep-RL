...
def run_training_loop(params):
    ...
    # store trajectories of experience
    ...
    for itr in range(params['n_iter']):
        ...
        if itr == 0:
            ...
            # `render`` whether you want to generate a video
        ...
        for _ in range(params['num_agent_train_steps_per_iter']):
          ...
          sample = indices[:params['train_batch_size']]
          ob_batch, ac_batch = replay_buffer.obs[sample], replay_buffer.acs[sample]
